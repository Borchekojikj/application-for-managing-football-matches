                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('players.update', ['id' => $player->id]) }}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="name" class="form-control" id="name" name="name" value="{{ old('name', $player->name) }}">
                        </div>
                        @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="date" class="form-control" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth', $player->date_of_birth) }}">
                        </div>
                        @error('date_of_birth')
                        <p class="alert alert-danger"> {{ $message }}</p>
                        @enderror
